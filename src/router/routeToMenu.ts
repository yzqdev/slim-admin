...
export const menuRouteFilter = (routes: RouteRecordRaw[]): RouteRecordRaw[] => {
  ...
  routes.forEach((r) => {
    ...
    let children = r.children && Array.isArray(r.children) && r.children.length !== 0 ? menuRouteFilter(r.children) : [];
